...
1. The `animation-duration` property for the star with class `star-1` should remain at 1s.
2. The `animation-duration` property for the star with class `star-2` should be 0.9s.
3. The `animation-duration` property for the star with class `star-3` should be 1.1s.
