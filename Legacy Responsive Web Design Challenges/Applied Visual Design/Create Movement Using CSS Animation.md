...
1. The `@keyframes` rule for `0%` should use the `left` offset of 0px.
2. The `@keyframes` rule for `50%` should use the `left` offset of 25px.
3. The `@keyframes` rule for `100%` should use the `left` offset of -25px.
