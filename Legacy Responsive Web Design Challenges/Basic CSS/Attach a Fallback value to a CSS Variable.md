...
1. The fallback value of `black` should be used in the `background` property of the `penguin-top` class.
2. The fallback value of `black` should be used in `background` property of the `penguin-bottom` class.
