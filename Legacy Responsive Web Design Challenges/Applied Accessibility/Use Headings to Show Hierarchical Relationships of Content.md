...
1. Your code should have 6 `h3` elements.
2. Your code should have 6 `h3` closing tags.
3. Your code should not have any `h5` elements.
4. Your code should not have any `h5` closing tags.
