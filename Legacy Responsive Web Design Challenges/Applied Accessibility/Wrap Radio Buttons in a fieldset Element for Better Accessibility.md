...
1. Your code should have a `fieldset` tag around the radio button set.
2. The `fieldset` element should have a closing tag.
3. Your code should have a `legend` tag around the text asking what level ninja a user is.
4. Your code should not have any `div` tags.
5. Your code should no longer have a `p` tag around the text asking what level ninja a user is.
