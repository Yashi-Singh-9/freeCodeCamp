...
1. Your code should only change the lightness value for the text `color` property to a value of 15%.
2. Your code should only change the lightness value for the `background-color` property to a value of 55%.
