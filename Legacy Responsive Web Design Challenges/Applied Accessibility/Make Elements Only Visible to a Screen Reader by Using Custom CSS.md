...
1. Your code should set the `position` property of the `sr-only` class to a value of `absolute`.
2. Your code should set the `left` property of the `sr-only` class to a value of `-10000px`.
3. Your code should set the `width` property of the `sr-only` class to a value of `1` pixel.
4. Your code should set the `height` property of the `sr-only` class to a value of `1` pixel.
